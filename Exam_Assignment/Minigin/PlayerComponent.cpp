...
{
	if (GetGameObject()->GetComponent<SpriteComponent>()->GetCurrentEvent() == NotifyEvent::EVENT_MOVE && m_isAttacking)
		GetGameObject()->GetComponent<SpriteComponent>()->onNotify(NotifyEvent::EVENT_ACTION);
